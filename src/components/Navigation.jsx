...
const navItems = [
    { icon: <HomeIcon className="w-6 h-6" />, title: 'Home', href: '/' },
    { icon: <UserIcon className="w-6 h-6" />, title: 'About Me', href: '/abouts' },
    { icon: <ClipboardListIcon className="w-6 h-6" />, title: 'Projects', href: '/projects' },
    { icon: <MailIcon className="w-6 h-6" />, title: 'Contact', href: '/contacts' },
];
...
const NavItem = ({ icon, title, href }) => {
    ...
    return (
        <li>
            <Link href={href}>
                <div className={clsx("block text-center hover:text-cyan-400 cursor-pointer",
...
export const Navigation = () => {
            ...
            <>
                <nav className="bg-base-100 shadow-md">
                    <div className="container mx-auto flex items-center justify-between py-4">
                        <span className="font-bold text-3xl text-cyan-500 cursor-pointer mx-5">keiru_dev</span>
                        <ThemeToggleIcon />
                    </div>
                </nav>
    ...
    return (
        <nav className="bg-base-100 shadow-md">
            <div className="container mx-auto flex items-center justify-between py-4">
                <Link href="/">
                    <div className="font-bold text-4xl text-cyan-500 cursor-pointer">keiru_dev</div>
                </Link>
