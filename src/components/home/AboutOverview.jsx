        ...
        <section className="relative mt-10" ref={ref}>
            ...
            >
                ...
                <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4 mb-8">
                    <motion.div
                        ref={ref}
                        className="stat text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl p-2 sm:p-3 md:p-4 lg:p-5 mx-20"
                        initial="hidden"
                        animate={isInView ? "visible" : "hidden"}
                    ...
                    >
                        ...
                        <div className="stat-title text-lg font-mono lg:text-lg text-cyan-300">Experience</div>
                    ...
                    >
                        ...
                        <div className="stat-title text-lg font-mono lg:text-lg text-cyan-300">Projects Made</div>
                    ...
                    >
                        ...
                        <div className="stat-title text-lg font-mono lg:text-lg text-cyan-300">Skills</div>
